...
const CursoAlfabetizacion = () => {
  ...
  const generarCertificado = () => {
    ...
    doc.setFontSize(16);
    doc.text("Ha completado exitosamente el curso de Alfabetización.", 60, 100);
    doc.text("Fecha: " + new Date().toLocaleDateString(), 60, 120);
    doc.text("Firma:", 60, 150);
    doc.text("____________________", 60, 160);
    doc.save("Certificado_Alfabetizacion.pdf");
  };

  return (
    <div className="curso-container">
      <Navbar />
      <h1 className="curso-titulo">Curso de Alfabetización</h1>
...
export default CursoAlfabetizacion;
