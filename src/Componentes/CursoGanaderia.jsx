...
const CursoGanaderia = () => {
  ...
  const preguntas = [
    { texto: "¿Cuál es la principal fuente de alimento para el ganado bovino?", respuesta: "pasto" },
    { texto: "¿Qué enfermedad afecta más comúnmente al ganado vacuno?", respuesta: "fiebre aftosa" },
    { texto: "¿Cómo se llama el proceso de selección de los mejores animales para reproducción?", respuesta: "mejoramiento genético" },
  ];
  ...
  const generarCertificado = () => {
    ...
    doc.setFontSize(16);
    doc.text("Ha completado exitosamente el curso de Ganadería.", 60, 100);
    doc.text("Fecha: " + new Date().toLocaleDateString(), 60, 120);
    doc.text("Firma:", 60, 150);
    doc.text("____________________", 60, 160);
    doc.save("Certificado_Ganaderia.pdf");
  };

  return (
    <div className="curso-container">
      <Navbar />
      <h1 className="curso-titulo">Curso de Ganadería</h1>
      ...
      <div className="curso-content">
        ...
        <div className="videos-container">
          ...
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/dcLP5h0RBiI"
            title="Video de Ganadería"
            frameBorder="0"
