...
import '../Componentes_css/PanelPlanSocial.css';

const PanelPlanSocial = () => {
  ...
  // ✅ Función para actualizar progreso del usuario en Firebase
  ...
  return (
    <div className="panel-plan-social">
...
export default PanelPlanSocial;
